...
```{r}
# Creating vectors of necessary metadata and merging into a dataframe
...
write.csv(gse_t_vs_m_results, "../data/gsea_results/gse_t_vs_m_results.csv")
...
write.csv(gse_m_vs_e_results, "../data/gsea_results/gse_m_vs_e_results.csv")
...
write.csv(gse_t_vs_e_results, "../data/gsea_results/gse_t_vs_e_results.csv")
...
write.csv(t_vs_m_kegg_gsea_results, "../data/gsea_results/t_vs_m_kegg_gsea_results.csv")
...
write.csv(m_vs_e_kegg_gsea_results, "../data/gsea_results/m_vs_e_kegg_gsea_results.csv")
...
write.csv(t_vs_e_kegg_gsea_results, "../data/gsea_results/t_vs_e_kegg_gsea_results.csv")
